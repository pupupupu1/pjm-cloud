package com.pjm.circleoffriendservice.util;
...
public class GeneratorCode {
    ...
    private static String packageName = "com.pjm.circleoffriendservice";
    private static String outDir = "D:\\SCAlibaba\\parent\\circle-of-friend\\circle-of-friend-service\\src\\main\\java";
    ...
    public static void main(String[] args) {
        ...
        generateByTables(serviceNameStartWithI, packageName,
                "circle_of_friends_comment","circle_of_friends_info");
    }

    private static void generateByTables(boolean serviceNameStartWithI, String packageName, String... tableNames) {
        GlobalConfig config = new GlobalConfig();
        String dbUrl = "jdbc:mysql://47.94.233.146:3306/pjm_cloud?serverTimezone=Asia/Shanghai&characterEncoding=utf-8&useSSL=true";
        DataSourceConfig dataSourceConfig = new DataSourceConfig();
        dataSourceConfig.setDbType(DbType.MYSQL)
                .setUrl(dbUrl)
                .setUsername("root")
                .setPassword("@18782217026")
