...
public class GeneratorCode {
    ...
    private static String packageName = "com.pjm.userservice.test";
    private static String outDir = "D:\\SCAlibaba\\parent\\user\\user-service\\src\\main\\java";
    ...
    public static void main(String[] args) {
        ...
        generateByTables(serviceNameStartWithI, packageName,
                "user_group_info","user_group_member_info");
    }

    private static void generateByTables(boolean serviceNameStartWithI, String packageName, String... tableNames) {
        GlobalConfig config = new GlobalConfig();
        String dbUrl = "jdbc:mysql://localhost:3306/pjm_cloud?serverTimezone=Asia/Shanghai&characterEncoding=utf-8&useSSL=true";
